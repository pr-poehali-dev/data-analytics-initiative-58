  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Я думала, что разобраться в своих чувствах невозможно. Но оказывается, иногда нужно просто найти правильные слова — и что-то внутри встаёт на место.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Читательница блога</p>
          <p className="text-sm text-primary-foreground/60 mt-1">После статьи о тревоге</p>
        </div>
      </div>
    </section>
  )
