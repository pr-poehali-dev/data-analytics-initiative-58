...
const steps = [
  {
    ...
    title: "Без осуждения",
    description:
      "Я пишу для людей, а не для академических журналов. Никаких диагнозов, никаких «ты делаешь это неправильно» — только бережный взгляд на то, что происходит.",
  },
  {
    number: "02",
    title: "Доказательно",
    description:
      "За каждой статьёй стоит реальная психологическая теория или исследование. Популярно — не значит поверхностно.",
  },
  {
    number: "03",
    title: "Практично",
    description:
      "Не просто «почему это происходит», но и «что с этим делать». Конкретные наблюдения, которые можно применить уже сегодня.",
  },
  {
    number: "04",
    title: "Честно",
    description:
      "Я сама учусь и не притворяюсь, что знаю все ответы. Это делает разговор живым и настоящим.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Как я
                <span className="italic"> пишу</span>
              </h2>
              <p
              ...
              >
                Хорошая статья о психологии — это не лекция и не инструкция. Это разговор, в котором вы узнаёте себя.
              </p>
            </div>
          </div>
